...
window.den = {
  ...
  presets: [
    ...
    { id: 'eshay_boy',          name: 'Eshay',    body: 'boy'  },
    { id: 'gym_bro',            name: 'Gym Bro',  body: 'boy'  },
    { id: 'suit_boy',           name: 'Suit',     body: 'boy'  },
    { id: 'skater_boy',         name: 'Skater',   body: 'boy'  },
    ...
    { id: 'club_girl',          name: 'Club',     body: 'girl' },
    { id: 'suit_girl',          name: 'Suit',     body: 'girl' },
    { id: 'gym_girl',           name: 'Gym',      body: 'girl' },
    { id: 'cocktail_girl',      name: 'Cocktail', body: 'girl' },
  ],
  FRAME_W,
  FRAME_H,
  SPRITE_VERSION,
